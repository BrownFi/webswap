    ...
    try {
      ...
      return Promise.resolve(Promise.all([pairContract.methods.priceFeed().call(), pairContract.methods.qti().call()])).then(function (_ref) {
        ...
        function _temp2() {
          ...
          return Promise.resolve(Promise.all([chainId === exports.ChainId.VICTION_MAINNET || chainId === exports.ChainId.SONIC_TESTNET || chainId === exports.ChainId.AURORA_TESTNET || chainId === exports.ChainId.TAIKO_TESTNET || chainId === exports.ChainId.BOBA_TESTNET || chainId === exports.ChainId.BOBA_MAINNET ? routerContractWithPrice.methods.getAmountsOutWithPrice(inputAmount.raw.toString(), path === null || path === void 0 ? void 0 : path.map(function (token) {
            return token.address;
            ...
            return token.address;
          })).call(), chainId !== exports.ChainId.VICTION_MAINNET && chainId !== exports.ChainId.SONIC_TESTNET && chainId !== exports.ChainId.AURORA_TESTNET && chainId !== exports.ChainId.TAIKO_TESTNET && chainId !== exports.ChainId.BOBA_TESTNET && chainId !== exports.ChainId.BOBA_MAINNET && priceFeedContract.methods.latestRoundData().call(), chainId !== exports.ChainId.VICTION_MAINNET && chainId !== exports.ChainId.SONIC_TESTNET && chainId !== exports.ChainId.AURORA_TESTNET && chainId !== exports.ChainId.TAIKO_TESTNET && chainId !== exports.ChainId.BOBA_TESTNET && chainId !== exports.ChainId.BOBA_MAINNET && priceFeedContract.methods.decimals().call(), (chainId === exports.ChainId.VICTION_MAINNET || chainId === exports.ChainId.SONIC_TESTNET || chainId === exports.ChainId.AURORA_TESTNET || chainId === exports.ChainId.TAIKO_TESTNET || chainId === exports.ChainId.BOBA_TESTNET || chainId === exports.ChainId.BOBA_MAINNET) && getLatestPrice(basePriceIds, quotePriceIds)])).then(function (_ref2) {
            ...
            var odPrice = chainId === exports.ChainId.VICTION_MAINNET || chainId === exports.ChainId.SONIC_TESTNET || chainId === exports.ChainId.AURORA_TESTNET || chainId === exports.ChainId.TAIKO_TESTNET || chainId === exports.ChainId.BOBA_TESTNET || chainId === exports.ChainId.BOBA_MAINNET ? qti === 1 ? basePrice / (quotePrice || Math.pow(10, 8)) : (quotePrice || Math.pow(10, 8)) / basePrice : +latestRound.answer / Math.pow(10, +decimals);
        ...
        var updateFee = 0;
        var _temp = function () {
          if (chainId === exports.ChainId.VICTION_MAINNET || chainId === exports.ChainId.SONIC_TESTNET || chainId === exports.ChainId.AURORA_TESTNET || chainId === exports.ChainId.TAIKO_TESTNET || chainId === exports.ChainId.BOBA_TESTNET || chainId === exports.ChainId.BOBA_MAINNET) {
    ...
    try {
      ...
      return Promise.resolve(Promise.all([pairContract.methods.priceFeed().call(), pairContract.methods.qti().call()])).then(function (_ref4) {
        var priceFeedAddress = _ref4[0],
          qti = _ref4[1];
        function _temp4() {
          return Promise.resolve(Promise.all([chainId === exports.ChainId.VICTION_MAINNET || chainId === exports.ChainId.SONIC_TESTNET || chainId === exports.ChainId.AURORA_TESTNET || chainId === exports.ChainId.TAIKO_TESTNET || chainId === exports.ChainId.BOBA_TESTNET || chainId === exports.ChainId.BOBA_MAINNET ? routerContractWithPrice.methods.getAmountsInWithPrice(outputAmount.raw.toString(), path === null || path === void 0 ? void 0 : path.map(function (token) {
            return token.address;
          }), priceFeedUpdateData).call({
            value: updateFee,
            from: account
            ...
            return token.address;
          })).call(), chainId !== exports.ChainId.VICTION_MAINNET && chainId !== exports.ChainId.SONIC_TESTNET && chainId !== exports.ChainId.AURORA_TESTNET && chainId !== exports.ChainId.TAIKO_TESTNET && chainId !== exports.ChainId.BOBA_TESTNET && chainId !== exports.ChainId.BOBA_MAINNET && priceFeedContract.methods.latestRoundData().call(), chainId !== exports.ChainId.VICTION_MAINNET && chainId !== exports.ChainId.SONIC_TESTNET && chainId !== exports.ChainId.AURORA_TESTNET && chainId !== exports.ChainId.TAIKO_TESTNET && chainId !== exports.ChainId.BOBA_TESTNET && chainId !== exports.ChainId.BOBA_MAINNET && priceFeedContract.methods.decimals().call(), (chainId === exports.ChainId.VICTION_MAINNET || chainId === exports.ChainId.SONIC_TESTNET || chainId === exports.ChainId.AURORA_TESTNET || chainId === exports.ChainId.TAIKO_TESTNET || chainId === exports.ChainId.BOBA_TESTNET || chainId === exports.ChainId.BOBA_MAINNET) && getLatestPrice(basePriceIds, quotePriceIds)])).then(function (_ref5) {
          ...
          if (tradeType === exports.TradeType.EXACT_INPUT) {
            ...
            var _temp = _for(function () {
              ...
              return Promise.resolve(pair.getOutputAmountAsync(amounts[_i], route.path, pair.chainId, pair.liquidityToken.address, account)).then(function (_ref) {
                ...
                if (route.chainId === exports.ChainId.BASE_SEPOLIA || route.chainId === exports.ChainId.AURORA_TESTNET || route.chainId === exports.ChainId.BOBA_TESTNET || route.chainId === exports.ChainId.NEOX_MAINNET || route.chainId === exports.ChainId.U2U_MAINNET || route.chainId === exports.ChainId.SCROLL_TESTNET || route.chainId === exports.ChainId.OP_MAINNET) {
        ...
        function _temp7(_result) {
          ...
          var _temp5 = function () {
            if (amountOut.token.equals(tokenOut)) {
              ...
              return Promise.resolve(newTrade.init(newRoute, originalAmountIn, exports.TradeType.EXACT_INPUT, account)).then(function () {
        ...
        function _temp12(_result3) {
          ...
          var _temp10 = function () {
            if (amountIn.token.equals(tokenIn)) {
              ...
              return Promise.resolve(newTrade.init(newRoute, originalAmountOut, exports.TradeType.EXACT_OUTPUT, account)).then(function () {
                sortedInsert(bestTrades, newTrade, maxNumResults, tradeComparator);
              });
            } else if (maxHops > 1 && pairs.length > 1) {
...
function getSwapCallArguments(trade, account, allowedSlippage, recipient, chainId, library, deadline) {
  var contract = chainId === exports.ChainId.VICTION_MAINNET || chainId === exports.ChainId.SONIC_TESTNET || chainId === exports.ChainId.AURORA_TESTNET || chainId === exports.ChainId.TAIKO_TESTNET || chainId === exports.ChainId.BOBA_TESTNET || chainId === exports.ChainId.BOBA_MAINNET ? getRouterContractWithPrice(chainId, library, account) : getRouterContract(chainId, library, account);
  if (!contract) {
    return [];
  }
  var swapMethods = [];
