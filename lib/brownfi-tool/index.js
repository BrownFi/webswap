    ...
    try {
      ...
      return Promise.resolve(Promise.all([pairContract.methods.priceFeed().call(), pairContract.methods.qti().call()])).then(function (_ref) {
        var priceFeedAddress = _ref[0],
          qti = _ref[1];
        function _temp2() {
          return Promise.resolve(Promise.all([chainId === exports.ChainId.VICTION_MAINNET || chainId === exports.ChainId.SONIC_TESTNET || chainId === exports.ChainId.AURORA_TESTNET || chainId === exports.ChainId.TAIKO_TESTNET || chainId === exports.ChainId.BOBA_TESTNET ? routerContractWithPrice.methods.getAmountsOutWithPrice(inputAmount.raw.toString(), path === null || path === void 0 ? void 0 : path.map(function (token) {
            ...
            return token.address;
          })).call(), chainId !== exports.ChainId.VICTION_MAINNET && chainId !== exports.ChainId.SONIC_TESTNET && chainId !== exports.ChainId.AURORA_TESTNET && chainId !== exports.ChainId.TAIKO_TESTNET && chainId !== exports.ChainId.BOBA_TESTNET && priceFeedContract.methods.latestRoundData().call(), chainId !== exports.ChainId.VICTION_MAINNET && chainId !== exports.ChainId.SONIC_TESTNET && chainId !== exports.ChainId.AURORA_TESTNET && chainId !== exports.ChainId.TAIKO_TESTNET && chainId !== exports.ChainId.BOBA_TESTNET && priceFeedContract.methods.decimals().call(), (chainId === exports.ChainId.VICTION_MAINNET || chainId === exports.ChainId.SONIC_TESTNET || chainId === exports.ChainId.AURORA_TESTNET || chainId === exports.ChainId.TAIKO_TESTNET || chainId === exports.ChainId.BOBA_TESTNET) && getLatestPrice(basePriceIds, quotePriceIds)])).then(function (_ref2) {
            ...
            var odPrice = chainId === exports.ChainId.VICTION_MAINNET || chainId === exports.ChainId.SONIC_TESTNET || chainId === exports.ChainId.AURORA_TESTNET || chainId === exports.ChainId.TAIKO_TESTNET || chainId === exports.ChainId.BOBA_TESTNET ? qti === 1 ? basePrice / (quotePrice || Math.pow(10, 8)) : (quotePrice || Math.pow(10, 8)) / basePrice : +latestRound.answer / Math.pow(10, +decimals);
        ...
        var updateFee = 0;
        var _temp = function () {
          if (chainId === exports.ChainId.VICTION_MAINNET || chainId === exports.ChainId.SONIC_TESTNET || chainId === exports.ChainId.AURORA_TESTNET || chainId === exports.ChainId.TAIKO_TESTNET || chainId === exports.ChainId.BOBA_TESTNET) {
    ...
    try {
      ...
      return Promise.resolve(Promise.all([pairContract.methods.priceFeed().call(), pairContract.methods.qti().call()])).then(function (_ref4) {
        var priceFeedAddress = _ref4[0],
          qti = _ref4[1];
        function _temp4() {
          return Promise.resolve(Promise.all([chainId === exports.ChainId.VICTION_MAINNET || chainId === exports.ChainId.SONIC_TESTNET || chainId === exports.ChainId.AURORA_TESTNET || chainId === exports.ChainId.TAIKO_TESTNET || chainId === exports.ChainId.BOBA_TESTNET ? routerContractWithPrice.methods.getAmountsInWithPrice(outputAmount.raw.toString(), path === null || path === void 0 ? void 0 : path.map(function (token) {
            return token.address;
          }), priceFeedUpdateData).call({
            value: updateFee,
            from: account
            ...
            return token.address;
          })).call(), chainId !== exports.ChainId.VICTION_MAINNET && chainId !== exports.ChainId.SONIC_TESTNET && chainId !== exports.ChainId.AURORA_TESTNET && chainId !== exports.ChainId.TAIKO_TESTNET && chainId !== exports.ChainId.BOBA_TESTNET && priceFeedContract.methods.latestRoundData().call(), chainId !== exports.ChainId.VICTION_MAINNET && chainId !== exports.ChainId.SONIC_TESTNET && chainId !== exports.ChainId.AURORA_TESTNET && chainId !== exports.ChainId.TAIKO_TESTNET && chainId !== exports.ChainId.BOBA_TESTNET && priceFeedContract.methods.decimals().call(), (chainId === exports.ChainId.VICTION_MAINNET || chainId === exports.ChainId.SONIC_TESTNET || chainId === exports.ChainId.AURORA_TESTNET || chainId === exports.ChainId.TAIKO_TESTNET || chainId === exports.ChainId.BOBA_TESTNET) && getLatestPrice(basePriceIds, quotePriceIds)])).then(function (_ref5) {
          ...
          if (tradeType === exports.TradeType.EXACT_INPUT) {
            ...
            var _temp = _for(function () {
              ...
              return Promise.resolve(pair.getOutputAmountAsync(amounts[_i], route.path, pair.chainId, pair.liquidityToken.address, account)).then(function (_ref) {
                ...
                if (route.chainId === exports.ChainId.BASE_SEPOLIA || route.chainId === exports.ChainId.AURORA_TESTNET || route.chainId === exports.ChainId.BOBA_TESTNET || route.chainId === exports.ChainId.NEOX_MAINNET) {
...
function getSwapCallArguments(trade, account, allowedSlippage, recipient, chainId, library, deadline) {
  var contract = chainId === exports.ChainId.VICTION_MAINNET || chainId === exports.ChainId.SONIC_TESTNET || chainId === exports.ChainId.AURORA_TESTNET || chainId === exports.ChainId.TAIKO_TESTNET || chainId === exports.ChainId.BOBA_TESTNET ? getRouterContractWithPrice(chainId, library, account) : getRouterContract(chainId, library, account);
  if (!contract) {
    return [];
  }
  var swapMethods = [];
