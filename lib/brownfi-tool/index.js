    ...
    try {
      ...
      return Promise.resolve(Promise.all([pairContract.methods.priceFeed().call(), pairContract.methods.qti().call()])).then(function (_ref) {
        var priceFeedAddress = _ref[0],
          qti = _ref[1];
        function _temp2() {
          return Promise.resolve(Promise.all([chainId === exports.ChainId.VICTION_MAINNET || chainId === exports.ChainId.SONIC_TESTNET || chainId === exports.ChainId.AURORA_TESTNET ? routerContractWithPrice.methods.getAmountsOutWithPrice(inputAmount.raw.toString(), path === null || path === void 0 ? void 0 : path.map(function (token) {
            ...
            var odPrice = chainId === exports.ChainId.VICTION_MAINNET || chainId === exports.ChainId.SONIC_TESTNET || chainId === exports.ChainId.AURORA_TESTNET ? qti === 1 ? basePrice / (quotePrice || Math.pow(10, 8)) : (quotePrice || Math.pow(10, 8)) / basePrice : +latestRound.answer / Math.pow(10, +decimals);
        ...
        var updateFee = 0;
        var _temp = function () {
          if (chainId === exports.ChainId.VICTION_MAINNET || chainId === exports.ChainId.SONIC_TESTNET || chainId === exports.ChainId.AURORA_TESTNET) {
    ...
    try {
      ...
      return Promise.resolve(Promise.all([pairContract.methods.priceFeed().call(), pairContract.methods.qti().call()])).then(function (_ref4) {
        var priceFeedAddress = _ref4[0],
          qti = _ref4[1];
        function _temp4() {
          return Promise.resolve(Promise.all([chainId === exports.ChainId.VICTION_MAINNET || chainId === exports.ChainId.SONIC_TESTNET || chainId === exports.ChainId.AURORA_TESTNET ? routerContractWithPrice.methods.getAmountsInWithPrice(outputAmount.raw.toString(), path === null || path === void 0 ? void 0 : path.map(function (token) {
            return token.address;
          }), priceFeedUpdateData).call({
            value: updateFee
...
function getSwapCallArguments(trade, account, allowedSlippage, recipient, chainId, library, deadline) {
  var contract = chainId === exports.ChainId.VICTION_MAINNET || chainId === exports.ChainId.SONIC_TESTNET || chainId === exports.ChainId.AURORA_TESTNET ? getRouterContractWithPrice(chainId, library, account) : getRouterContract(chainId, library, account);
  if (!contract) {
    return [];
  }
  var swapMethods = [];
