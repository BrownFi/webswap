          ...
          if (tradeType === exports.TradeType.EXACT_INPUT) {
            ...
            var _temp = _for(function () {
              ...
              return Promise.resolve(pair.getOutputAmountAsync(amounts[_i], route.path, pair.chainId, pair.liquidityToken.address)).then(function (_ref) {
                ...
                if (route.chainId === exports.ChainId.BASE_SEPOLIA || route.chainId === exports.ChainId.AURORA_TESTNET) {
...
var BOBA_USDC = new Token(exports.ChainId.BOBA_TESTNET, '0x0f97Ca4E6B118502f83DD3Ce836A14Cb4937ed2a', 18, 'USDC', 'USDC');
