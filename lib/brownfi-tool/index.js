          ...
          if (tradeType === exports.TradeType.EXACT_INPUT) {
            ...
            var _temp = _for(function () {
              ...
              return Promise.resolve(pair.getOutputAmountAsync(amounts[_i], route.path, pair.chainId, pair.liquidityToken.address, account)).then(function (_ref) {
                ...
                if (route.chainId === exports.ChainId.BASE_SEPOLIA || route.chainId === exports.ChainId.AURORA_TESTNET || route.chainId === exports.ChainId.BOBA_TESTNET || route.chainId === exports.ChainId.NEOX_MAINNET || route.chainId === exports.ChainId.U2U_MAINNET || route.chainId === exports.ChainId.SCROLL_TESTNET) {
