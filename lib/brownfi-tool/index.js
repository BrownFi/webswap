...
var removeLiquidity = function removeLiquidity(chainId, library, account, parsedAmounts, deadline, allowedSlippage, approval, signatureData) {
  try {
    ...
    var amountsMin = (_amountsMin = {}, _amountsMin[exports.Field.CURRENCY_A] = calculateSlippageAmount(currencyAmountA, allowedSlippage)[0], _amountsMin[exports.Field.CURRENCY_B] = calculateSlippageAmount(currencyAmountB, allowedSlippage)[0], _amountsMin);
...
var addLiquidity = function addLiquidity(chainId, library, account, parsedAmountA, parsedAmountB, deadline, noLiquidity, allowedSlippage) {
  try {
    ...
    var amountsMin = chainId === exports.ChainId.SEPOLIA ? (_ref = {}, _ref[exports.Field.CURRENCY_A] = 0, _ref[exports.Field.CURRENCY_B] = 0, _ref) : (_ref2 = {}, _ref2[exports.Field.CURRENCY_A] = calculateSlippageAmount(parsedAmountA, noLiquidity ? 0 : allowedSlippage)[0], _ref2[exports.Field.CURRENCY_B] = calculateSlippageAmount(parsedAmountB, noLiquidity ? 0 : allowedSlippage)[0], _ref2);
    ...
    if (currencyA === ETHER || currencyB === ETHER) {
      ...
      component = {
        ...
        amountTokenMin: amountsMin[tokenBIsETH ? exports.Field.CURRENCY_A : exports.Field.CURRENCY_B].toString(),
        amountETHMin: amountsMin[tokenBIsETH ? exports.Field.CURRENCY_B : exports.Field.CURRENCY_A].toString(),
        to: account,
      ...
      component = {
        ...
        amountAMin: amountsMin[exports.Field.CURRENCY_A].toString(),
        amountBMin: amountsMin[exports.Field.CURRENCY_B].toString(),
        to: account,
        deadline: deadline.toHexString(),
        dataA: '0x',
        dataB: '0x'
    ...
    var inputs = chainId === exports.ChainId.SEPOLIA ? [component] : args;
