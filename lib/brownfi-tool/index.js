...
var addLiquidity = function addLiquidity(chainId, library, account, parsedAmountA, parsedAmountB, exactFieldInput, deadline, noLiquidity, allowedSlippage) {
  try {
    ...
    var amountsMin = isTestnetSkipAmountsMin(chainId) ? (_ref = {}, _ref[exports.Field.CURRENCY_A] = 0, _ref[exports.Field.CURRENCY_B] = 0, _ref) : (_ref2 = {}, _ref2[exports.Field.CURRENCY_A] = calculateSlippageAmount(parsedAmountA, noLiquidity || exactFieldInput === exports.Field.CURRENCY_A ? 0 : allowedSlippage)[0], _ref2[exports.Field.CURRENCY_B] = calculateSlippageAmount(parsedAmountB, noLiquidity || exactFieldInput === exports.Field.CURRENCY_B ? 0 : allowedSlippage)[0], _ref2);
...
exports.isRouterV2 = isRouterV2;
exports.removeLiquidity = removeLiquidity;
exports.supportContractWithPrice = supportContractWithPrice;
