		...
		inputs: [
			{
				...
				internalType: "struct IBrownFiV2Router.AddLiquidityParams",
				name: "params",
				type: "tuple"
			}
		],
		...
		inputs: [
			{
				...
				internalType: "struct IBrownFiV2Router.AddLiquidityETHParams",
				name: "params",
				type: "tuple"
			}
		],
...
var addLiquidity = function addLiquidity(chainId, library, account, parsedAmountA, parsedAmountB, deadline, noLiquidity, allowedSlippage) {
  try {
    ...
    var amountsMin = isTestnetSkipAmountsMin(chainId) ? (_ref = {}, _ref[Field.CURRENCY_A] = 0, _ref[Field.CURRENCY_B] = 0, _ref) : (_ref2 = {}, _ref2[Field.CURRENCY_A] = calculateSlippageAmount(parsedAmountA, noLiquidity ? 0 : allowedSlippage)[0], _ref2[Field.CURRENCY_B] = calculateSlippageAmount(parsedAmountB, noLiquidity ? 0 : allowedSlippage)[0], _ref2);
    var estimate, method, args, component, value;
    if (currencyA === ETHER || currencyB === ETHER) {
      var _wrappedCurrency$addr3, _wrappedCurrency3, _wrappedCurrency$addr4, _wrappedCurrency4;
      ...
      component = {
        token: (_wrappedCurrency$addr4 = (_wrappedCurrency4 = wrappedCurrency$1(tokenBIsETH ? currencyA : currencyB, chainId)) === null || _wrappedCurrency4 === void 0 ? void 0 : _wrappedCurrency4.address) != null ? _wrappedCurrency$addr4 : '',
        amountTokenDesired: (tokenBIsETH ? parsedAmountA : parsedAmountB).raw.toString(),
        amountTokenMin: amountsMin[tokenBIsETH ? Field.CURRENCY_A : Field.CURRENCY_B].toString(),
        amountETHMin: amountsMin[tokenBIsETH ? Field.CURRENCY_B : Field.CURRENCY_A].toString(),
        to: account,
      ...
      var _wrappedCurrency$addr5, _wrappedCurrency5, _wrappedCurrency$addr6, _wrappedCurrency6, _wrappedCurrency$addr7, _wrappedCurrency7, _wrappedCurrency$addr8, _wrappedCurrency8;
      estimate = router.estimateGas.addLiquidity;
      method = router.addLiquidity;
      args = [(_wrappedCurrency$addr5 = (_wrappedCurrency5 = wrappedCurrency$1(currencyA, chainId)) === null || _wrappedCurrency5 === void 0 ? void 0 : _wrappedCurrency5.address) != null ? _wrappedCurrency$addr5 : '', (_wrappedCurrency$addr6 = (_wrappedCurrency6 = wrappedCurrency$1(currencyB, chainId)) === null || _wrappedCurrency6 === void 0 ? void 0 : _wrappedCurrency6.address) != null ? _wrappedCurrency$addr6 : '', parsedAmountA.raw.toString(), parsedAmountB.raw.toString(), amountsMin[Field.CURRENCY_A].toString(), amountsMin[Field.CURRENCY_B].toString(), account, deadline.toHexString()];
      component = {
        tokenA: (_wrappedCurrency$addr7 = (_wrappedCurrency7 = wrappedCurrency$1(currencyA, chainId)) === null || _wrappedCurrency7 === void 0 ? void 0 : _wrappedCurrency7.address) != null ? _wrappedCurrency$addr7 : '',
        tokenB: (_wrappedCurrency$addr8 = (_wrappedCurrency8 = wrappedCurrency$1(currencyB, chainId)) === null || _wrappedCurrency8 === void 0 ? void 0 : _wrappedCurrency8.address) != null ? _wrappedCurrency$addr8 : '',
    ...
    var inputs = chainId === ChainId.SEPOLIA ? [component] : args;
