    ...
    try {
      ...
      return Promise.resolve(Promise.all([pairContract.methods.priceFeed().call(), pairContract.methods.qti().call()])).then(function (_ref) {
        var priceFeedAddress = _ref[0],
          qti = _ref[1];
        function _temp2() {
          return Promise.resolve(Promise.all([chainId === ChainId.VICTION_MAINNET || chainId === ChainId.SONIC_TESTNET ? routerContractWithPrice.methods.getAmountsOutWithPrice(inputAmount.raw.toString(), path === null || path === void 0 ? void 0 : path.map(function (token) {
            ...
            return token.address;
          })).call(), chainId !== ChainId.VICTION_MAINNET && chainId !== ChainId.SONIC_TESTNET && priceFeedContract.methods.latestRoundData().call(), chainId !== ChainId.VICTION_MAINNET && chainId !== ChainId.SONIC_TESTNET && priceFeedContract.methods.decimals().call(), (chainId === ChainId.VICTION_MAINNET || chainId === ChainId.SONIC_TESTNET) && getLatestPrice(basePriceIds, quotePriceIds)])).then(function (_ref2) {
            ...
            var odPrice = chainId === ChainId.VICTION_MAINNET || chainId === ChainId.SONIC_TESTNET ? qti === 1 ? basePrice / (quotePrice || Math.pow(10, 8)) : (quotePrice || Math.pow(10, 8)) / basePrice : +latestRound.answer / Math.pow(10, +decimals);
        ...
        var updateFee = 0;
        var _temp = function () {
          if (chainId === ChainId.VICTION_MAINNET || chainId === ChainId.SONIC_TESTNET) {
    ...
    try {
      ...
      return Promise.resolve(Promise.all([pairContract.methods.priceFeed().call(), pairContract.methods.qti().call()])).then(function (_ref4) {
        var priceFeedAddress = _ref4[0],
          qti = _ref4[1];
        function _temp4() {
          return Promise.resolve(Promise.all([chainId === ChainId.VICTION_MAINNET || chainId === ChainId.SONIC_TESTNET ? routerContractWithPrice.methods.getAmountsInWithPrice(outputAmount.raw.toString(), path === null || path === void 0 ? void 0 : path.map(function (token) {
            return token.address;
          }), priceFeedUpdateData).call({
            value: updateFee
          }) : routerContract.methods.getAmountsIn(outputAmount.raw.toString(), path === null || path === void 0 ? void 0 : path.map(function (token) {
            return token.address;
          })).call(), chainId !== ChainId.VICTION_MAINNET && chainId !== ChainId.SONIC_TESTNET && priceFeedContract.methods.latestRoundData().call(), chainId !== ChainId.VICTION_MAINNET && chainId !== ChainId.SONIC_TESTNET && priceFeedContract.methods.decimals().call(), (chainId === ChainId.VICTION_MAINNET || chainId === ChainId.SONIC_TESTNET) && getLatestPrice(basePriceIds, quotePriceIds)])).then(function (_ref5) {
...
var ROUTER_ADDRESS_WITH_PRICE = (_ROUTER_ADDRESS_WITH_ = {}, _ROUTER_ADDRESS_WITH_[ChainId.VICTION_MAINNET] = '0x66d82F09024D0AADB71B1335f5C791Ef25B7Bfdc', _ROUTER_ADDRESS_WITH_[ChainId.SONIC_TESTNET] = '0x0f97Ca4E6B118502f83DD3Ce836A14Cb4937ed2a', _ROUTER_ADDRESS_WITH_);
var PYTH_ADDRESS = (_PYTH_ADDRESS = {}, _PYTH_ADDRESS[ChainId.VICTION_MAINNET] = '0xA2aa501b19aff244D90cc15a4Cf739D2725B5729', _PYTH_ADDRESS[ChainId.SONIC_TESTNET] = '0x96124d1f6e44ffdf1fb5d6d74bb2de1b7fbe7376', _PYTH_ADDRESS);
var RPC_URLS = (_RPC_URLS = {}, _RPC_URLS[ChainId.SEPOLIA] = 'https://sepolia.infura.io/v3/5f8bfb8bae3945f28da51d768f736046', _RPC_URLS[ChainId.BSC_TESTNET] = 'https://data-seed-prebsc-1-s1.binance.org:8545', _RPC_URLS[ChainId.VICTION_TESTNET] = 'https://rpc-testnet.viction.xyz', _RPC_URLS[ChainId.VICTION_MAINNET] = 'https://rpc.viction.xyz', _RPC_URLS[ChainId.SONIC_TESTNET] = 'https://rpc.testnet.soniclabs.com', _RPC_URLS[ChainId.MINATO_SONEIUM] = 'https://rpc.minato.soneium.org/', _RPC_URLS[ChainId.BASE_SEPOLIA] = 'https://base-sepolia-rpc.publicnode.com', _RPC_URLS[ChainId.UNICHAIN_SEPOLIA] = 'https://sepolia.unichain.org', _RPC_URLS);
var Field;
(function (Field) {
...
function getSwapCallArguments(trade, account, allowedSlippage, recipient, chainId, library, deadline) {
  var contract = chainId === ChainId.VICTION_MAINNET || chainId === ChainId.SONIC_TESTNET ? getRouterContractWithPrice(chainId, library, account) : getRouterContract(chainId, library, account);
  if (!contract) {
    return [];
  }
  var swapMethods = [];
