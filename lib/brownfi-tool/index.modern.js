...
var addLiquidity = function addLiquidity(chainId, library, account, parsedAmountA, parsedAmountB, exactFieldInput, deadline, noLiquidity, allowedSlippage, version) {
  try {
    ...
    var amountsMin = (_amountsMin = {}, _amountsMin[Field.CURRENCY_A] = calculateSlippageAmount(parsedAmountA, noLiquidity || exactFieldInput === Field.CURRENCY_A ? 0 : allowedSlippage)[0], _amountsMin[Field.CURRENCY_B] = calculateSlippageAmount(parsedAmountB, noLiquidity || exactFieldInput === Field.CURRENCY_B ? 0 : allowedSlippage)[0], _amountsMin);
