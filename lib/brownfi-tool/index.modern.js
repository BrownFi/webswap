          ...
          if (tradeType === TradeType.EXACT_INPUT) {
            ...
            var _temp = _for(function () {
              ...
              return Promise.resolve(pair.getOutputAmountAsync(amounts[_i], route.path, pair.chainId, pair.liquidityToken.address)).then(function (_ref) {
                ...
                if (route.chainId === ChainId.BASE_SEPOLIA) {
...
var AURORA_USDC = new Token(ChainId.AURORA_TESTNET, '0xaca0aC694aCcB0d1d0C39046a0780CB5475d36E6', 6, 'USDC', 'USDC');
...
export { AURORA_USDC, AddressZero, AppComponent, ApprovalState, BASES_TO_TRACK_LIQUIDITY_FOR, BASE_USDC, BIPS_BASE, ChainId, ChainIdHex, Currency, CurrencyAmount, DAI, ETHER, FACTORY_ADDRESS, Fetcher, Field, Fraction, INIT_CODE_HASH, InsufficientInputAmountError, InsufficientReservesError, MINIMUM_LIQUIDITY, PINNED_PAIRS, PYTH_ADDRESS, Pair, Percent, Price, ROUTER_ADDRESS, ROUTER_ADDRESS_WITH_PRICE, RPC_URLS, Rounding, Route, Router, SwapCallbackState, Token, TokenAmount, Trade, TradeType, UNICHAIN_USDC, USDC, USDT, WBTC, WETH, ZERO_ADDRESS, addLiquidity, addLiquidityStarket, callSwapContract, callSwapContractStarknet, currencyEquals, inputOutputComparator, removeLiquidity, toV2LiquidityToken, tradeComparator };
