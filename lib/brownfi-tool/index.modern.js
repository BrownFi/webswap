  ...
  try {
    ...
    return Promise.resolve(_catch(function () {
      ...
      return Promise.resolve(factoryContract.methods.priceFeedIds(address).call()).then(function (priceFeedId) {
        return Promise.resolve(pythContract.methods.getPriceUnsafe(priceFeedId).call()).then(function (priceUnsafe) {
          var price = priceUnsafe[0],
            conf = priceUnsafe[1],
            expo = priceUnsafe[2],
            publishTime = priceUnsafe[3];
