...
var getPythPrice = function getPythPrice(address, chainId) {
  try {
...
var Pair = /*#__PURE__*/function () {
  ...
  _proto.getTradingFee = function getTradingFee() {
    try {
      ...
      var v2 = isRouterV2(_this.chainId);
      var pairContract = new web3.eth.Contract(v2 ? IPairV2 : IPair, _this.liquidityToken.address);
      return Promise.resolve(pairContract.methods.fee().call()).then(function (fee) {
        ...
        return v2 ? Promise.resolve(pairContract.methods.PRECISION().call()).then(_temp) : _temp(10000);
      });
    } catch (e) {
      return Promise.reject(e);
    }
        ...
        if (supportContractWithPrice(chainId)) {
          ...
          var _temp2 = function () {
            if (isRouterV2(chainId)) {
              return Promise.resolve(solidityPack(chainId, path.map(function (token) {
                return token.address;
...
var PYTH_ADDRESS = (_PYTH_ADDRESS = {}, _PYTH_ADDRESS[ChainId.SEPOLIA] = '0xDd24F84d36BF92C65F92307595335bdFab5Bbd21', _PYTH_ADDRESS[ChainId.ARBITRUM_SEPOLIA] = '0x4374e5a8b9C22271E9EB878A2AA31DE97DF15DAF', _PYTH_ADDRESS[ChainId.ARBITRUM_MAINNET] = '0xff1a0f4744e8582DF1aE09D5611b887B6a12925C', _PYTH_ADDRESS[ChainId.BSC_MAINNET] = '0x4D7E825f80bDf85e913E0DD2A2D54927e9dE1594', _PYTH_ADDRESS[ChainId.BASE_MAINNET] = '0x8250f4aF4B972684F7b336503E2D6dFeDeB1487a', _PYTH_ADDRESS[ChainId.VICTION_MAINNET] = '0xA2aa501b19aff244D90cc15a4Cf739D2725B5729', _PYTH_ADDRESS[ChainId.SONIC_TESTNET] = '0x96124d1f6e44ffdf1fb5d6d74bb2de1b7fbe7376', _PYTH_ADDRESS[ChainId.AURORA_TESTNET] = '0x74f09cb3c7e2A01865f424FD14F6dc9A14E3e94E', _PYTH_ADDRESS[ChainId.TAIKO_TESTNET] = '0x2880aB155794e7179c9eE2e38200202908C17B43', _PYTH_ADDRESS[ChainId.BOBA_TESTNET] = '0x8D254a21b3C86D32F7179855531CE99164721933', _PYTH_ADDRESS[ChainId.BOBA_MAINNET] = '0x4374e5a8b9C22271E9EB878A2AA31DE97DF15DAF', _PYTH_ADDRESS[ChainId.BERA_MAINNET] = '0x2880aB155794e7179c9eE2e38200202908C17B43', _PYTH_ADDRESS);
...
var callSwapContractStarknet = function callSwapContractStarknet(chainId, library, account, trade, allowedSlippage, deadline) {
  try {
    return Promise.resolve(_catch(function () {
      ...
      var swapCall = new Contract$1(ISNRouter, ROUTER_ADDRESS[chainId], library).populate('swap_exact_tokens_for_tokens', {
...
var removeLiquidity = function removeLiquidity(chainId, library, account, parsedAmounts, deadline, allowedSlippage, approval, signatureData) {
  try {
    ...
    var amountsMin = isTestnetSkipAmountsMin(chainId) ? (_ref3 = {}, _ref3[Field.CURRENCY_A] = 0, _ref3[Field.CURRENCY_B] = 0, _ref3) : (_ref4 = {}, _ref4[Field.CURRENCY_A] = calculateSlippageAmount(currencyAmountA, allowedSlippage)[0], _ref4[Field.CURRENCY_B] = calculateSlippageAmount(currencyAmountB, allowedSlippage)[0], _ref4);
...
var addLiquidity = function addLiquidity(chainId, library, account, parsedAmountA, parsedAmountB, exactFieldInput, deadline, noLiquidity, allowedSlippage) {
  try {
    var _ref, _ref2;
    var _temp8 = function _temp8() {
      var _value, _console;
      var inputs = isV2 ? argsV2 : args;
    ...
    var amountsMin = isTestnetSkipAmountsMin(chainId) ? (_ref = {}, _ref[Field.CURRENCY_A] = 0, _ref[Field.CURRENCY_B] = 0, _ref) : (_ref2 = {}, _ref2[Field.CURRENCY_A] = calculateSlippageAmount(parsedAmountA, noLiquidity || exactFieldInput === Field.CURRENCY_A ? 0 : allowedSlippage)[0], _ref2[Field.CURRENCY_B] = calculateSlippageAmount(parsedAmountB, noLiquidity || exactFieldInput === Field.CURRENCY_B ? 0 : allowedSlippage)[0], _ref2);
    ...
    var _temp7 = function () {
      if (currencyA === ETHER || currencyB === ETHER) {
        ...
        args = [(_wrappedCurrency$addr3 = (_wrappedCurrency3 = wrappedCurrency$1(tokenBIsETH ? currencyA : currencyB, chainId)) === null || _wrappedCurrency3 === void 0 ? void 0 : _wrappedCurrency3.address) != null ? _wrappedCurrency$addr3 : '', (tokenBIsETH ? parsedAmountA : parsedAmountB).raw.toString(), amountsMin[tokenBIsETH ? Field.CURRENCY_A : Field.CURRENCY_B].toString(), amountsMin[tokenBIsETH ? Field.CURRENCY_B : Field.CURRENCY_A].toString(), account, deadline.toHexString()];
        ...
        var _temp2 = function () {
          if (isV2) {
            var _wrappedCurrency$addr4, _wrappedCurrency4, _wrappedCurrency$addr5, _wrappedCurrency5, _wrappedCurrency$addr6, _wrappedCurrency6;
            var _deadline$toHexString = deadline.toHexString(),
              _amountsMin$toString2 = amountsMin[tokenBIsETH ? Field.CURRENCY_B : Field.CURRENCY_A].toString(),
              _amountsMin$toString = amountsMin[tokenBIsETH ? Field.CURRENCY_A : Field.CURRENCY_B].toString(),
              _amountMaxOther$raw$t = amountMaxOther.raw.toString(),
            ...
            return Promise.resolve(solidityPack(chainId, [(_wrappedCurrency$addr5 = (_wrappedCurrency5 = wrappedCurrency$1(currencyA, chainId)) === null || _wrappedCurrency5 === void 0 ? void 0 : _wrappedCurrency5.address) != null ? _wrappedCurrency$addr5 : '', (_wrappedCurrency$addr6 = (_wrappedCurrency6 = wrappedCurrency$1(currencyB, chainId)) === null || _wrappedCurrency6 === void 0 ? void 0 : _wrappedCurrency6.address) != null ? _wrappedCurrency$addr6 : ''])).then(function (_solidityPack) {
              argsV2 = [_temp, _amountMaxOther$raw$t, _amountsMin$toString, _amountsMin$toString2, account, _deadline$toHexString, _solidityPack];
            });
          }
        }();
        if (_temp2 && _temp2.then) return _temp2.then(function () {});
      } else {
        var _wrappedCurrency$addr7, _wrappedCurrency7, _wrappedCurrency$addr8, _wrappedCurrency8;
        var _temp6 = function _temp6() {
          value = null;
        };
        estimate = router.estimateGas.addLiquidity;
        method = router.addLiquidity;
        args = [(_wrappedCurrency$addr7 = (_wrappedCurrency7 = wrappedCurrency$1(currencyA, chainId)) === null || _wrappedCurrency7 === void 0 ? void 0 : _wrappedCurrency7.address) != null ? _wrappedCurrency$addr7 : '', (_wrappedCurrency$addr8 = (_wrappedCurrency8 = wrappedCurrency$1(currencyB, chainId)) === null || _wrappedCurrency8 === void 0 ? void 0 : _wrappedCurrency8.address) != null ? _wrappedCurrency$addr8 : '', parsedAmountA.raw.toString(), parsedAmountB.raw.toString(), amountsMin[Field.CURRENCY_A].toString(), amountsMin[Field.CURRENCY_B].toString(), account, deadline.toHexString()];
        ...
        var _temp5 = function () {
          if (isV2) {
            var _wrappedCurrency$addr9, _wrappedCurrency9, _wrappedCurrency$addr10, _wrappedCurrency10, _wrappedCurrency$addr11, _wrappedCurrency11, _wrappedCurrency$addr12, _wrappedCurrency12;
            var _deadline$toHexString2 = deadline.toHexString(),
              _amountsMin$Field$CUR2 = amountsMin[Field.CURRENCY_B].toString(),
              _amountsMin$Field$CUR = amountsMin[Field.CURRENCY_A].toString(),
              _amountMaxB$raw$toStr = amountMaxB.raw.toString(),
              _amountMaxA$raw$toStr = amountMaxA.raw.toString(),
              _temp4 = (_wrappedCurrency$addr9 = (_wrappedCurrency9 = wrappedCurrency$1(currencyB, chainId)) === null || _wrappedCurrency9 === void 0 ? void 0 : _wrappedCurrency9.address) != null ? _wrappedCurrency$addr9 : '',
              _temp3 = (_wrappedCurrency$addr10 = (_wrappedCurrency10 = wrappedCurrency$1(currencyA, chainId)) === null || _wrappedCurrency10 === void 0 ? void 0 : _wrappedCurrency10.address) != null ? _wrappedCurrency$addr10 : '';
            return Promise.resolve(solidityPack(chainId, [(_wrappedCurrency$addr11 = (_wrappedCurrency11 = wrappedCurrency$1(currencyA, chainId)) === null || _wrappedCurrency11 === void 0 ? void 0 : _wrappedCurrency11.address) != null ? _wrappedCurrency$addr11 : '', (_wrappedCurrency$addr12 = (_wrappedCurrency12 = wrappedCurrency$1(currencyB, chainId)) === null || _wrappedCurrency12 === void 0 ? void 0 : _wrappedCurrency12.address) != null ? _wrappedCurrency$addr12 : ''])).then(function (_solidityPack2) {
              argsV2 = [_temp3, _temp4, _amountMaxA$raw$toStr, _amountMaxB$raw$toStr, _amountsMin$Field$CUR, _amountsMin$Field$CUR2, account, _deadline$toHexString2, _solidityPack2];
            });
          }
        }();
...
var addLiquidityStarket = function addLiquidityStarket(chainId, library, account, parsedAmountA, parsedAmountB, deadline) {
  try {
    return Promise.resolve(_catch(function () {
      ...
      var routerContract = new Contract$1(ISNRouter, ROUTER_ADDRESS[chainId], library);
      var currencyA = parsedAmountA === null || parsedAmountA === void 0 ? void 0 : parsedAmountA.currency;
      var currencyB = parsedAmountB === null || parsedAmountB === void 0 ? void 0 : parsedAmountB.currency;
...
export { AddressZero, AppComponent, ApprovalState, BASES_TO_TRACK_LIQUIDITY_FOR, BIPS_BASE, ChainId, ChainIdHex, Currency, CurrencyAmount, DAI, ETHER, FACTORY_ADDRESS, Fetcher, Field, Fraction, INIT_CODE_HASH, InsufficientInputAmountError, InsufficientReservesError, METIS_USDC, MINIMUM_LIQUIDITY, PINNED_PAIRS, PYTH_ADDRESS, Pair, Percent, Price, ROUTER_ADDRESS, ROUTER_ADDRESS_WITH_PRICE, RPC_URLS, Rounding, Route, Router, SwapCallbackState, Token, TokenAmount, Trade, TradeType, UNICHAIN_USDC, USDC, USDT, WBTC, WETH, WETH_ONLY, ZERO_ADDRESS, addLiquidity, addLiquidityStarket, callSwapContract, callSwapContractStarknet, currencyEquals, getPythPrice, getPythPricePair, inputOutputComparator, isRouterV2, removeLiquidity, supportContractWithPrice, toV2LiquidityToken, tradeComparator };
