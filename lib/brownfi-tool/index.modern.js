    ...
    this.init = function (route, amount, tradeType, account) {
      try {
        var _temp4 = function _temp4() {
          ...
          console.log('trade data: ', +_this.outputAmount.raw, +_this.inputAmount.raw, +oPrice, _this.priceImpact, _this.updateFee);
        };
