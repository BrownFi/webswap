  ...
  _proto.getInputAmountAsync = function getInputAmountAsync(outputAmount, pairs, path, chainId, account) {
    try {
      var _temp4 = function _temp4() {
        ...
        return [inputAmount, new Pair(inputReserve.add(inputAmount), outputReserve.subtract(outputAmount)), priceUpdate, updateFee];
      };
      var _this2 = this;
...
var Trade = /*#__PURE__*/function () {
  ...
  Trade.bestTradeExactIn = function bestTradeExactIn(account, pairs, currencyAmountIn, currencyOut, _temp8, currentPairs, originalAmountIn, bestTrades) {
    var _ref5 = _temp8 === void 0 ? {} : _temp8,
    ...
    try {
      ...
      var _temp7 = _forTo(pairs, function (i) {
        ...
        var _temp5 = _catch(function () {
          ...
          return Promise.resolve(computePair.getOutputAmountAsync(amountIn, [].concat(currentPairs, [pair]), path, chainId, account)).then(function (_computePair$getOutpu) {
      ...
      return Promise.resolve(_temp7 && _temp7.then ? _temp7.then(function (_result2) {
        return _exit ? _result2 : bestTrades;
      }) : _exit ? _temp7 : bestTrades);
    } catch (e) {
      return Promise.reject(e);
    }
  };
  Trade.bestTradeExactOut = function bestTradeExactOut(account, pairs, currencyIn, currencyAmountOut, _temp15, currentPairs, originalAmountOut, bestTrades) {
    var _ref6 = _temp15 === void 0 ? {} : _temp15,
    ...
    try {
      ...
      var _temp14 = _for(function () {
        return !_exit2 && _i < (pairs === null || pairs === void 0 ? void 0 : pairs.length);
      }, function () {
        return _i++;
      }, function () {
        ...
        var _temp12 = _catch(function () {
          var amountOut = wrappedAmount(originalAmountOut, chainId);
          var computePair = getComputePair([pair].concat(currentPairs), path);
          return Promise.resolve(computePair.getInputAmountAsync(amountOut, [].concat(currentPairs, [pair]), path, chainId, account)).then(function (_computePair$getInput) {
            amountIn = _computePair$getInput[0];
          });
        }, function (error) {
      ...
      return Promise.resolve(_temp14 && _temp14.then ? _temp14.then(function (_result4) {
        return _exit2 ? _result4 : bestTrades;
      }) : _exit2 ? _temp14 : bestTrades);
    } catch (e) {
      return Promise.reject(e);
    }
  };
