...
var removeLiquidity = function removeLiquidity(chainId, library, account, parsedAmounts, deadline, allowedSlippage, approval, signatureData) {
  try {
    ...
    var amountsMin = (_amountsMin = {}, _amountsMin[Field.CURRENCY_A] = calculateSlippageAmount(currencyAmountA, allowedSlippage)[0], _amountsMin[Field.CURRENCY_B] = calculateSlippageAmount(currencyAmountB, allowedSlippage)[0], _amountsMin);
...
var addLiquidity = function addLiquidity(chainId, library, account, parsedAmountA, parsedAmountB, deadline, noLiquidity, allowedSlippage) {
  try {
    ...
    var amountsMin = chainId === ChainId.SEPOLIA ? (_ref = {}, _ref[Field.CURRENCY_A] = 0, _ref[Field.CURRENCY_B] = 0, _ref) : (_ref2 = {}, _ref2[Field.CURRENCY_A] = calculateSlippageAmount(parsedAmountA, noLiquidity ? 0 : allowedSlippage)[0], _ref2[Field.CURRENCY_B] = calculateSlippageAmount(parsedAmountB, noLiquidity ? 0 : allowedSlippage)[0], _ref2);
...
function toV2LiquidityToken(_ref3) {
  var tokenA = _ref3[0],
    tokenB = _ref3[1];
