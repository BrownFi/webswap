...
var ChainIdHex = (_ChainIdHex = {}, _ChainIdHex[ChainId.MAINNET] = '0x1', _ChainIdHex[ChainId.SEPOLIA] = '0xaa36a7', _ChainIdHex[ChainId.BSC_TESTNET] = '0x61', _ChainIdHex[ChainId.VICTION_TESTNET] = '0x59', _ChainIdHex[ChainId.VICTION_MAINNET] = '0x58', _ChainIdHex[ChainId.SONIC_TESTNET] = '0xFAA5', _ChainIdHex[ChainId.MINATO_SONEIUM] = '0x79A', _ChainIdHex[ChainId.BASE_SEPOLIA] = '0x14a34', _ChainIdHex[ChainId.UNICHAIN_SEPOLIA] = '0x515', _ChainIdHex[ChainId.AURORA_TESTNET] = '0x4e454153', _ChainIdHex[ChainId.METIS_MAINNET] = '0x440', _ChainIdHex[ChainId.TAIKO_TESTNET] = '0x28c61', _ChainIdHex[ChainId.BOBA_TESTNET] = '0x70d2', _ChainIdHex[ChainId.NEOX_MAINNET] = '0xba93', _ChainIdHex[ChainId.U2U_MAINNET] = '0x27', _ChainIdHex[ChainId.SCROLL_TESTNET] = '0x8274f', _ChainIdHex[ChainId.ARBITRUM_MAINNET] = '0xa4b1', _ChainIdHex[ChainId.OP_MAINNET] = '0xa', _ChainIdHex[ChainId.BOBA_MAINNET] = '0x120', _ChainIdHex[ChainId.BERA_MAINNET] = '0x138de', _ChainIdHex);
var TradeType;
(function (TradeType) {
...
function supportContractWithPrice(chainId) {
  return chainId === ChainId.VICTION_MAINNET || chainId === ChainId.SONIC_TESTNET || chainId === ChainId.AURORA_TESTNET || chainId === ChainId.TAIKO_TESTNET || chainId === ChainId.BOBA_TESTNET || chainId === ChainId.BOBA_MAINNET || chainId === ChainId.BERA_MAINNET;
}
...
var getPriceFeedUpdateData = function getPriceFeedUpdateData(ids) {
  try {
...
var Pair = /*#__PURE__*/function () {
  ...
  _proto.getOutputAmountAsync = function getOutputAmountAsync(inputAmount, path, chainId, pairs, account) {
    try {
      var _temp2 = function _temp2() {
        ...
        return [outputAmount, new Pair(inputReserve.add(inputAmount), outputReserve.subtract(outputAmount)), priceUpdate, updateFee];
      };
      var _this = this;
      ...
      var _temp = function () {
        if (supportContractWithPrice(chainId)) {
          return Promise.resolve(Promise.all(pairs.map(function (pair) {
            ...
            var uniqueIds = allIds.filter(function (item, index, flatArray) {
              return flatArray.indexOf(item) === index;
            });
            return Promise.resolve(getPriceFeedUpdateData(uniqueIds)).then(function (_getPriceFeedUpdateDa) {
              priceUpdate = _getPriceFeedUpdateDa;
              var pythContract = new web3.eth.Contract(IPyth, PYTH_ADDRESS[chainId]);
              return Promise.resolve(pythContract.methods.getUpdateFee(priceUpdate).call()).then(function (_pythContract$methods) {
                updateFee = _pythContract$methods;
                return Promise.resolve(routerContractWithPrice.methods.getAmountsOutWithPrice(inputAmount.raw.toString(), path === null || path === void 0 ? void 0 : path.map(function (token) {
          ...
          return Promise.resolve(routerContract.methods.getAmountsOut(inputAmount.raw.toString(), path === null || path === void 0 ? void 0 : path.map(function (token) {
            return token.address;
  ...
  _proto.getInputAmountAsync = function getInputAmountAsync(outputAmount, path, chainId, pairAddress, account) {
    try {
      var _this2 = this;
      ...
      return Promise.resolve(Promise.all([pairContract.methods.priceFeed().call(), pairContract.methods.qti().call()])).then(function (_ref2) {
        var priceFeedAddress = _ref2[0],
          qti = _ref2[1];
        function _temp4() {
          return Promise.resolve(Promise.all([supportContractWithPrice(chainId) ? routerContractWithPrice.methods.getAmountsInWithPrice(outputAmount.raw.toString(), path === null || path === void 0 ? void 0 : path.map(function (token) {
            return token.address;
            ...
            return token.address;
          })).call(), !supportContractWithPrice(chainId) && priceFeedContract.methods.latestRoundData().call(), !supportContractWithPrice(chainId) && priceFeedContract.methods.decimals().call(), supportContractWithPrice(chainId) && getLatestPrice(basePriceIds, quotePriceIds)])).then(function (_ref3) {
            var _latestPrice$parsed;
            var balances = _ref3[0],
              latestRound = _ref3[1],
              decimals = _ref3[2],
              latestPrice = _ref3[3];
            var basePrice = 1;
            ...
            var odPrice = supportContractWithPrice(chainId) ? qti === 1 ? basePrice / (quotePrice || Math.pow(10, 8)) : (quotePrice || Math.pow(10, 8)) / basePrice : +latestRound.answer / Math.pow(10, +decimals);
        ...
        var _temp3 = function () {
          if (supportContractWithPrice(chainId)) {
            var pythPriceFeedContract = new web3.eth.Contract(IPythPriceFeed, priceFeedAddress);
            return Promise.resolve(Promise.all([pythPriceFeedContract.methods.baseTokenPriceId().call(), pythPriceFeedContract.methods.quoteTokenPriceId().call()])).then(function (_ref4) {
              var baseTokenPriceId = _ref4[0],
                quoteTokenPriceId = _ref4[1];
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    var _this = this;
    this.init = function (route, amount, tradeType, account) {
      try {
        var _temp4 = function _temp4() {
          _this.route = route;
          _this.tradeType = tradeType;
          _this.inputAmount = tradeType === TradeType.EXACT_INPUT ? amount : route.input === ETHER ? CurrencyAmount.ether(amounts[0].raw) : amounts[0];
          _this.outputAmount = tradeType === TradeType.EXACT_OUTPUT ? amount : route.output === ETHER ? CurrencyAmount.ether(amounts[amounts.length - 1].raw) : amounts[amounts.length - 1];
          ...
          if (!_this.priceImpact) {
            _this.nextMidPrice = Price.fromRoute(new Route(nextPairs, route.input));
            _this.priceImpact = computePriceImpact(route.midPrice, _this.inputAmount, _this.outputAmount);
          }
        };
        ...
        var _temp3 = function () {
          if (tradeType === TradeType.EXACT_INPUT) {
            ...
            var _temp = _for(function () {
              ...
              return Promise.resolve(pair.getOutputAmountAsync(amounts[_i], route.path, pair.chainId, route.pairs, account)).then(function (_ref) {
            ...
            var _temp2 = _for(function () {
              ...
              return Promise.resolve(pair.getInputAmountAsync(amounts[_i2], route.path, pair.chainId, pair.liquidityToken.address, account)).then(function (_ref2) {
  ...
  Trade.bestTradeExactIn = function bestTradeExactIn(account, pairs, currencyAmountIn, currencyOut, _temp10, currentPairs, originalAmountIn, bestTrades) {
    var _ref3 = _temp10 === void 0 ? {} : _temp10,
    ...
    try {
      ...
      var _temp9 = _forTo(pairs, function (i) {
        function _temp8(_result) {
          ...
          var _temp6 = function () {
            if (amountOut.token.equals(tokenOut)) {
              ...
              return Promise.resolve(newTrade.init(newRoute, originalAmountIn, TradeType.EXACT_INPUT, account)).then(function () {
        ...
        var _temp7 = _catch(function () {
          var amountIn = wrappedAmount(originalAmountIn, chainId);
          var pairs = [].concat(currentPairs, [pair]);
          var inputReserve = pairs[0].tokenAmounts[0].token.equals(path[0]) ? pairs[0].tokenAmounts[0] : pairs[0].tokenAmounts[1];
          var outputReserve = pairs[pairs.length - 1].tokenAmounts[0].token.equals(path[path.length - 1]) ? pairs[pairs.length - 1].tokenAmounts[0] : pairs[pairs.length - 1].tokenAmounts[1];
          var computePair = new Pair(inputReserve, outputReserve);
          return Promise.resolve(computePair.getOutputAmountAsync(amountIn, path, chainId, [].concat(currentPairs, [pair]), account)).then(function (_computePair$getOutpu) {
            amountOut = _computePair$getOutpu[0];
            console.log('path', path);
            console.log('amountIn', amountIn.currency.symbol, +amountIn.raw / Math.pow(10, amountIn.currency.decimals));
            console.log('amountOut', amountOut.currency.symbol, +amountOut.raw / Math.pow(10, amountOut.currency.decimals));
          });
        }, function (error) {
      ...
      }) : _exit ? _temp9 : bestTrades);
    } catch (e) {
      return Promise.reject(e);
    }
  };
  Trade.bestTradeExactOut = function bestTradeExactOut(account, pairs, currencyIn, currencyAmountOut, _temp17, currentPairs, originalAmountOut, bestTrades) {
    var _ref4 = _temp17 === void 0 ? {} : _temp17,
    ...
    try {
      ...
      var _temp16 = _for(function () {
        ...
        function _temp15(_result3) {
          ...
          var _temp13 = function () {
            if (amountIn.token.equals(tokenIn)) {
              ...
              return Promise.resolve(newTrade.init(newRoute, originalAmountOut, TradeType.EXACT_OUTPUT, account)).then(function () {
                sortedInsert(bestTrades, newTrade, maxNumResults, tradeComparator);
              });
            } else {
        ...
        var _temp14 = _catch(function () {
          var path = Trade.getPath(currencyIn, pairs);
          return Promise.resolve(pair.getInputAmountAsync(amountOut, path, chainId, pair.liquidityToken.address, account)).then(function (_pair$getInputAmountA) {
      ...
      return Promise.resolve(_temp16 && _temp16.then ? _temp16.then(function (_result4) {
        return _exit2 ? _result4 : bestTrades;
      }) : _exit2 ? _temp16 : bestTrades);
    } catch (e) {
      return Promise.reject(e);
    }
  };
...
var BASE_USDC = new Token(ChainId.BASE_SEPOLIA, '0x036CbD53842c5426634e7929541eC2318f3dCF7e', 6, 'USDC', 'USDC');
...
var WETH_ONLY = (_WETH_ONLY = {}, _WETH_ONLY[ChainId.MAINNET] = [WETH[ChainId.MAINNET]], _WETH_ONLY[ChainId.SEPOLIA] = [WETH[ChainId.SEPOLIA]], _WETH_ONLY[ChainId.SN_MAIN] = [WETH[ChainId.SN_MAIN]], _WETH_ONLY[ChainId.SN_SEPOLIA] = [WETH[ChainId.SN_SEPOLIA]], _WETH_ONLY[ChainId.BSC_TESTNET] = [WETH[ChainId.BSC_TESTNET]], _WETH_ONLY[ChainId.VICTION_TESTNET] = [WETH[ChainId.VICTION_TESTNET]], _WETH_ONLY[ChainId.VICTION_MAINNET] = [WETH[ChainId.VICTION_MAINNET]], _WETH_ONLY[ChainId.SONIC_TESTNET] = [WETH[ChainId.SONIC_TESTNET]], _WETH_ONLY[ChainId.MINATO_SONEIUM] = [WETH[ChainId.MINATO_SONEIUM]], _WETH_ONLY[ChainId.BASE_SEPOLIA] = [WETH[ChainId.BASE_SEPOLIA]], _WETH_ONLY[ChainId.UNICHAIN_SEPOLIA] = [WETH[ChainId.UNICHAIN_SEPOLIA]], _WETH_ONLY[ChainId.AURORA_TESTNET] = [WETH[ChainId.AURORA_TESTNET]], _WETH_ONLY[ChainId.METIS_MAINNET] = [WETH[ChainId.METIS_MAINNET]], _WETH_ONLY[ChainId.TAIKO_TESTNET] = [WETH[ChainId.TAIKO_TESTNET]], _WETH_ONLY[ChainId.BOBA_TESTNET] = [WETH[ChainId.BOBA_TESTNET]], _WETH_ONLY[ChainId.NEOX_MAINNET] = [WETH[ChainId.NEOX_MAINNET]], _WETH_ONLY[ChainId.U2U_MAINNET] = [WETH[ChainId.U2U_MAINNET]], _WETH_ONLY[ChainId.SCROLL_TESTNET] = [WETH[ChainId.SCROLL_TESTNET]], _WETH_ONLY[ChainId.ARBITRUM_MAINNET] = [WETH[ChainId.ARBITRUM_MAINNET]], _WETH_ONLY[ChainId.OP_MAINNET] = [WETH[ChainId.OP_MAINNET]], _WETH_ONLY[ChainId.BOBA_MAINNET] = [WETH[ChainId.BOBA_MAINNET]], _WETH_ONLY[ChainId.BERA_MAINNET] = [WETH[ChainId.BERA_MAINNET]], _WETH_ONLY);
...
var addLiquidity = function addLiquidity(chainId, library, account, parsedAmountA, parsedAmountB, deadline, noLiquidity, allowedSlippage) {
  try {
    ...
    var amountsMin = (_amountsMin = {}, _amountsMin[Field.CURRENCY_A] = calculateSlippageAmount(parsedAmountA, noLiquidity ? 0 : allowedSlippage)[0], _amountsMin[Field.CURRENCY_B] = calculateSlippageAmount(parsedAmountB, noLiquidity ? 0 : allowedSlippage)[0], _amountsMin);
    ...
    if (currencyA === ETHER || currencyB === ETHER) {
      ...
      args = [(_wrappedCurrency$addr4 = (_wrappedCurrency4 = wrappedCurrency$1(currencyA, chainId)) === null || _wrappedCurrency4 === void 0 ? void 0 : _wrappedCurrency4.address) != null ? _wrappedCurrency$addr4 : '', (_wrappedCurrency$addr5 = (_wrappedCurrency5 = wrappedCurrency$1(currencyB, chainId)) === null || _wrappedCurrency5 === void 0 ? void 0 : _wrappedCurrency5.address) != null ? _wrappedCurrency$addr5 : '', parsedAmountA.raw.toString(), parsedAmountB.raw.toString(), amountsMin[Field.CURRENCY_A].toString(), amountsMin[Field.CURRENCY_B].toString(), account, deadline.toHexString()];
      value = null;
    }
