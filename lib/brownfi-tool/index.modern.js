...
var Pair = /*#__PURE__*/function () {
  ...
  _proto.getTradingFee = function getTradingFee() {
    try {
      ...
      var isV2 = _this.version === 2;
      var pairContract = new web3.eth.Contract(isV2 ? IPairV2 : IPair, _this.liquidityToken.address);
      return Promise.resolve(pairContract.methods.fee().call()).then(function (fee) {
        function _temp(precision) {
          return Number(fee) * 100 / precision;
        }
        return isV2 ? Promise.resolve(pairContract.methods.PRECISION().call()).then(_temp) : _temp(10000);
      });
    } catch (e) {
      return Promise.reject(e);
    }
