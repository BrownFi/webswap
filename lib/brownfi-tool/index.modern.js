          ...
          if (tradeType === TradeType.EXACT_INPUT) {
            ...
            var _temp = _for(function () {
              ...
              return Promise.resolve(pair.getOutputAmountAsync(amounts[_i], route.path, pair.chainId, pair.liquidityToken.address)).then(function (_ref) {
                ...
                if (route.chainId === ChainId.BASE_SEPOLIA || route.chainId === ChainId.AURORA_TESTNET) {
        ...
        function _temp7(_result) {
          ...
          var _temp5 = function () {
            if (amountOut.token.equals(tokenOut)) {
              ...
              return Promise.resolve(newTrade.init(newRoute, originalAmountIn, TradeType.EXACT_INPUT)).then(function () {
        ...
        function _temp12(_result3) {
          ...
          var _temp10 = function () {
            if (amountIn.token.equals(tokenIn)) {
              ...
              return Promise.resolve(newTrade.init(newRoute, originalAmountOut, TradeType.EXACT_OUTPUT)).then(function () {
                sortedInsert(bestTrades, newTrade, maxNumResults, tradeComparator);
              });
            } else if (maxHops > 1 && pairs.length > 1) {
...
var BOBA_USDC = new Token(ChainId.BOBA_TESTNET, '0x0f97Ca4E6B118502f83DD3Ce836A14Cb4937ed2a', 18, 'USDC', 'USDC');
