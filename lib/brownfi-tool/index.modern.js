...
var Trade = /*#__PURE__*/function () {
          ...
          if (tradeType === TradeType.EXACT_INPUT) {
            ...
            var _temp = _for(function () {
              ...
              return Promise.resolve(pair.getOutputAmountAsync(amounts[_i], route.path, pair.chainId, pair.liquidityToken.address, account)).then(function (_ref) {
                ...
                if (route.chainId === ChainId.BASE_SEPOLIA || route.chainId === ChainId.AURORA_TESTNET || route.chainId === ChainId.BOBA_TESTNET || route.chainId === ChainId.NEOX_MAINNET || route.chainId === ChainId.U2U_MAINNET || route.chainId === ChainId.SCROLL_TESTNET || route.chainId === ChainId.OP_MAINNET || route.chainId === ChainId.BERA_MAINNET) {
                  oPrice *= qti === 1 && (nextPairs[0].token1.name === outputAmount.currency.name || route.input === ETHER) || qti === 0 && (nextPairs[0].token0.name === amounts[_i].currency.name || route.output === ETHER) ? 1 / +odPrice : +odPrice;
                } else {
            ...
            var _temp2 = _for(function () {
              ...
              return Promise.resolve(pair.getInputAmountAsync(amounts[_i2], route.path, pair.chainId, pair.liquidityToken.address, account)).then(function (_ref2) {
                ...
                if (route.chainId === ChainId.BASE_SEPOLIA || route.chainId === ChainId.AURORA_TESTNET || route.chainId === ChainId.BOBA_TESTNET || route.chainId === ChainId.NEOX_MAINNET || route.chainId === ChainId.U2U_MAINNET || route.chainId === ChainId.SCROLL_TESTNET || route.chainId === ChainId.OP_MAINNET || route.chainId === ChainId.BERA_MAINNET) {
                  oPrice *= qti === 1 && (nextPairs[0].token1.name === amounts[_i2].currency.name || route.input === ETHER) || qti === 0 && (nextPairs[0].token0.name === inputAmount.currency.name || route.output === ETHER) ? 1 / +odPrice : +odPrice;
                } else {
  ...
  Trade.bestTradeExactIn = function bestTradeExactIn(account, pairs, currencyAmountIn, currencyOut, _temp9, currentPairs, originalAmountIn, bestTrades) {
        ...
        function _temp7(_result) {
          ...
          var _temp5 = function () {
            if (amountOut.token.equals(tokenOut)) {
              ...
              Trade.bestTradeExactIn(account, pairsExcludingThisPair, amountOut, currencyOut, {
  ...
  Trade.bestTradeExactOut = function bestTradeExactOut(account, pairs, currencyIn, currencyAmountOut, _temp14, currentPairs, originalAmountOut, bestTrades) {
        ...
        function _temp12(_result3) {
          ...
          var _temp10 = function () {
            if (amountIn.token.equals(tokenIn)) {
              ...
              Trade.bestTradeExactOut(account, pairsExcludingThisPair, currencyIn, amountIn, {
                maxNumResults: maxNumResults,
                maxHops: maxHops - 1
