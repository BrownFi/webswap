  ...
  try {
    ...
    return Promise.resolve(_catch(function () {
      ...
      return Promise.resolve(Promise.all([pairContract.methods.priceFeed().call(), pairContract.methods.qti().call()])).then(function (_ref) {
        ...
        return Promise.resolve(Promise.all([pythPriceFeedContract.methods.baseTokenPriceId().call(), pythPriceFeedContract.methods.quoteTokenPriceId().call()])).then(function (priceFeedIds) {
          var pythContract = new web3.eth.Contract(IPythUpgradable, PYTH_ADDRESS[chainId]);
