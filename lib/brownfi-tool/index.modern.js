...
var Pair = /*#__PURE__*/function () {
  ...
  _proto.getOutputAmountAsync = function getOutputAmountAsync(inputAmount, path, chainId, pairAddress, account) {
    try {
      var _this = this;
      ...
      return Promise.resolve(Promise.all([pairContract.methods.priceFeed().call(), pairContract.methods.qti().call()])).then(function (_ref) {
        var priceFeedAddress = _ref[0],
          qti = _ref[1];
        function _temp2() {
          return Promise.resolve(Promise.all([chainId === ChainId.VICTION_MAINNET || chainId === ChainId.SONIC_TESTNET || chainId === ChainId.AURORA_TESTNET || chainId === ChainId.TAIKO_TESTNET || chainId === ChainId.BOBA_TESTNET || chainId === ChainId.BOBA_MAINNET || chainId === ChainId.BERA_MAINNET ? routerContractWithPrice.methods.getAmountsOutWithPrice(inputAmount.raw.toString(), path === null || path === void 0 ? void 0 : path.map(function (token) {
            ...
            return token.address;
          })).call(), chainId !== ChainId.VICTION_MAINNET && chainId !== ChainId.SONIC_TESTNET && chainId !== ChainId.AURORA_TESTNET && chainId !== ChainId.TAIKO_TESTNET && chainId !== ChainId.BOBA_TESTNET && chainId !== ChainId.BOBA_MAINNET && chainId !== ChainId.BERA_MAINNET && priceFeedContract.methods.latestRoundData().call(), chainId !== ChainId.VICTION_MAINNET && chainId !== ChainId.SONIC_TESTNET && chainId !== ChainId.AURORA_TESTNET && chainId !== ChainId.TAIKO_TESTNET && chainId !== ChainId.BOBA_TESTNET && chainId !== ChainId.BOBA_MAINNET && chainId !== ChainId.BERA_MAINNET && priceFeedContract.methods.decimals().call(), (chainId === ChainId.VICTION_MAINNET || chainId === ChainId.SONIC_TESTNET || chainId === ChainId.AURORA_TESTNET || chainId === ChainId.TAIKO_TESTNET || chainId === ChainId.BOBA_TESTNET || chainId === ChainId.BOBA_MAINNET || chainId === ChainId.BERA_MAINNET) && getLatestPrice(basePriceIds, quotePriceIds)])).then(function (_ref2) {
            ...
            var odPrice = chainId === ChainId.VICTION_MAINNET || chainId === ChainId.SONIC_TESTNET || chainId === ChainId.AURORA_TESTNET || chainId === ChainId.TAIKO_TESTNET || chainId === ChainId.BOBA_TESTNET || chainId === ChainId.BOBA_MAINNET || chainId === ChainId.BERA_MAINNET ? qti === 1 ? basePrice / (quotePrice || Math.pow(10, 8)) : (quotePrice || Math.pow(10, 8)) / basePrice : +latestRound.answer / Math.pow(10, +decimals);
        ...
        var updateFee = 0;
        var _temp = function () {
          if (chainId === ChainId.VICTION_MAINNET || chainId === ChainId.SONIC_TESTNET || chainId === ChainId.AURORA_TESTNET || chainId === ChainId.TAIKO_TESTNET || chainId === ChainId.BOBA_TESTNET || chainId === ChainId.BOBA_MAINNET || chainId === ChainId.BERA_MAINNET) {
    ...
    try {
      ...
      return Promise.resolve(Promise.all([pairContract.methods.priceFeed().call(), pairContract.methods.qti().call()])).then(function (_ref4) {
        var priceFeedAddress = _ref4[0],
          qti = _ref4[1];
        function _temp4() {
          return Promise.resolve(Promise.all([chainId === ChainId.VICTION_MAINNET || chainId === ChainId.SONIC_TESTNET || chainId === ChainId.AURORA_TESTNET || chainId === ChainId.TAIKO_TESTNET || chainId === ChainId.BOBA_TESTNET || chainId === ChainId.BOBA_MAINNET || chainId === ChainId.BERA_MAINNET ? routerContractWithPrice.methods.getAmountsInWithPrice(outputAmount.raw.toString(), path === null || path === void 0 ? void 0 : path.map(function (token) {
            return token.address;
          }), priceFeedUpdateData).call({
            value: updateFee,
            from: account
            ...
            return token.address;
          })).call(), chainId !== ChainId.VICTION_MAINNET && chainId !== ChainId.SONIC_TESTNET && chainId !== ChainId.AURORA_TESTNET && chainId !== ChainId.TAIKO_TESTNET && chainId !== ChainId.BOBA_TESTNET && chainId !== ChainId.BOBA_MAINNET && chainId !== ChainId.BERA_MAINNET && priceFeedContract.methods.latestRoundData().call(), chainId !== ChainId.VICTION_MAINNET && chainId !== ChainId.SONIC_TESTNET && chainId !== ChainId.AURORA_TESTNET && chainId !== ChainId.TAIKO_TESTNET && chainId !== ChainId.BOBA_TESTNET && chainId !== ChainId.BOBA_MAINNET && chainId !== ChainId.BERA_MAINNET && priceFeedContract.methods.decimals().call(), (chainId === ChainId.VICTION_MAINNET || chainId === ChainId.SONIC_TESTNET || chainId === ChainId.AURORA_TESTNET || chainId === ChainId.TAIKO_TESTNET || chainId === ChainId.BOBA_TESTNET || chainId === ChainId.BOBA_MAINNET || chainId === ChainId.BERA_MAINNET) && getLatestPrice(basePriceIds, quotePriceIds)])).then(function (_ref5) {
    ...
    this.init = function (route, amount, tradeType, account) {
      try {
        var _temp4 = function _temp4() {
          ...
          var K = 0.001;
          var finalPairs = nextPairs[nextPairs.length - 1];
          var tokenOutReserve = finalPairs.token0.symbol === _this.outputAmount.currency.symbol ? finalPairs.reserve0 : finalPairs.reserve1;
          var amountOut = +_this.outputAmount.raw / Math.pow(10, _this.outputAmount.currency.decimals);
          var reserve = +tokenOutReserve.raw / Math.pow(10, tokenOutReserve.currency.decimals);
          _this.priceImpactK = K * amountOut / (reserve - amountOut) * 100;
        ...
        var _temp3 = function () {
          if (tradeType === TradeType.EXACT_INPUT) {
            ...
            var _temp = _for(function () {
              ...
              return Promise.resolve(pair.getOutputAmountAsync(amounts[_i], route.path, pair.chainId, pair.liquidityToken.address, account)).then(function (_ref) {
                ...
                var inputToken = amounts[_i].currency;
                var isForward = qti === 0 && nextPair.token0.name === inputToken.name || qti === 1 && nextPair.token1.name === inputToken.name;
                oPrice *= isForward ? +odPrice : 1 / +odPrice;
            ...
            var _temp2 = _for(function () {
              ...
              return Promise.resolve(pair.getInputAmountAsync(amounts[_i2], route.path, pair.chainId, pair.liquidityToken.address, account)).then(function (_ref2) {
                ...
                var inputToken = inputAmount.currency;
                var isForward = qti === 0 && nextPair.token0.name === inputToken.name || qti === 1 && nextPair.token1.name === inputToken.name;
                oPrice *= isForward ? +odPrice : 1 / +odPrice;
                newPriceUpdate = prices;
                newUpdateFee = updateFeeData;
    ...
    try {
      ...
      var _temp9 = _forTo(pairs, function (i) {
        ...
        var _temp7 = _catch(function () {
          var path = Trade.getPath(currencyAmountIn.currency, pairs);
          return Promise.resolve(pair.getOutputAmountAsync(amountIn, path, chainId, pair.liquidityToken.address, account)).then(function (_pair$getOutputAmount) {
...
function getSwapCallArguments(trade, account, allowedSlippage, recipient, chainId, library, deadline) {
  var contract = chainId === ChainId.VICTION_MAINNET || chainId === ChainId.SONIC_TESTNET || chainId === ChainId.AURORA_TESTNET || chainId === ChainId.TAIKO_TESTNET || chainId === ChainId.BOBA_TESTNET || chainId === ChainId.BOBA_MAINNET || chainId === ChainId.BERA_MAINNET ? getRouterContractWithPrice(chainId, library, account) : getRouterContract(chainId, library, account);
  if (!contract) {
    return [];
  }
  var swapMethods = [];
