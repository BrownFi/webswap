...
export async function onRequest(context) {
  ...
  if (chainId !== 4663 || !Array.isArray(poolIdentifiers) || poolIdentifiers.length > 30 || poolIdentifiers.some((id) => typeof id !== 'string' || !ALLOWED_POOL_IDS.has(id))) return Response.json({ pools: [] }, { status: 400 })
  const pools = []
