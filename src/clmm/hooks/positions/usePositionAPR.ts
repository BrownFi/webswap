import { useNativePriceQuery, usePoolFeeDataQuery, useSinglePoolQuery } from "@clmm/graphql/generated/graphql";
...
export function usePositionAPR(poolId: Address | undefined, position: Position | undefined, positionId?: string | undefined) {
    ...
    const { data: bundles } = useNativePriceQuery({ client: infoClient, skip: !hasSubgraph });
