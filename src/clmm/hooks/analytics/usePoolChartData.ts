import { usePoolDayDatasQuery, usePoolHourDatasQuery } from "@clmm/graphql/generated/graphql";
import { useClients } from "@clmm/hooks/graphql/useClients";
import { CHART_SPAN, ChartSpanType, POOL_CHART_TYPE, PoolChartTypeType } from "@clmm/types/swap-chart";
import { UNIX_TIMESTAMPS, isDefined } from "@clmm/utils";
import { USE_UNISWAP_PLACEHOLDER_DATA } from "@clmm/config/graphql-urls";
