...
/**
 * Generic (?) metric helper — an interactive, shadow-less tooltip with an
 * optional clickable "Learn More" link. Uses MouseoverTooltip (stays open when
 * the cursor moves into the tooltip) so the link is reachable, unlike the plain
 * QuestionHelper which closes on mouse-leave.
 */
